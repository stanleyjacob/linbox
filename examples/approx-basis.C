...
#endif // EXTRA_TIMINGS_ON
		chrono.clear(); chrono.start(); // time the approximant basis computation
		AppBas.popov_pmbasis(appbas, *sys, d, shift);
		chrono.stop();
#ifdef TIMINGS_ON
...
int main(int argc, char** argv){
	...
	size_t f=0; // which function to benchmark: 0:all; 1:mbasis; 2:pmbasis; 3:newmbasis; 4:newpmbasis; 5:popov_pmbasis
	...
	static Argument args[] = {
		...
		{ 'f', "-f f", "Set the targeted function to benchmark (0:mbasis; 1:mbasis; 2:pmbasis; 3:newmbasis; 4:newpmbasis; 5:popov_pmbasis.", TYPE_INT, &f },
	...
	if (p>0 or (b<26 && logd>b-4)) {
		...
		bench_approximant_basis(GF,rand,m,n,d,f,t,r);
	}
		...
		bench_approximant_basis(GF,G,m,n,d,f,t,r);
	}
